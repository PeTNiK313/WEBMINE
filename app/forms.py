...
class AnketaForm(forms.Form):
    ...
    income = forms.ChoiceField(label='Как часто вы заходите на наш сайт:', choices=(('1','Каждый день'),('2','Несколько раз в день'), ('3','Несколько раз в неделю'), ('4','Несколько раз в месяц')),initial=1)
